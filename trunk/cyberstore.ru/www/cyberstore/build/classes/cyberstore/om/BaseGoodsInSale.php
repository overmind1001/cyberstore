...
/**
 * Base class that represents a row from the 'goods_in_sale' table.
 *
 * 
 *
 * @package    propel.generator.cyberstore.om
 */
abstract class BaseGoodsInSale extends BaseObject  implements Persistent
{

	/**
	 * Peer class name
	 */
	const PEER = 'GoodsInSalePeer';
	...
	/**
	 * The value for the good_id field.
	 * @var        int
	 */
	protected $good_id;
	...
	public function setPrice($v)
	{
		...
		if ($this->price !== $v) {
			$this->price = $v;
			$this->modifiedColumns[] = GoodsInSalePeer::PRICE;
		}
	...
	public function setCount($v)
	{
		...
		if ($this->count !== $v) {
			$this->count = $v;
			$this->modifiedColumns[] = GoodsInSalePeer::COUNT;
		}
	...
	/**
	 * Set the value of [good_id] column.
	 * 
	 * @param      int $v new value
	 * @return     GoodsInSale The current object (for fluent API support)
	 */
	public function setGoodId($v)
	{
		if ($v !== null) {
			$v = (int) $v;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->sale_id = ($row[$startcol + 3] !== null) ? (int) $row[$startcol + 3] : null;
			$this->good_id = ($row[$startcol + 4] !== null) ? (int) $row[$startcol + 4] : null;
			$this->resetModified();
			...
			return $startcol + 5; // 5 = GoodsInSalePeer::NUM_HYDRATE_COLUMNS.

		} catch (Exception $e) {
			throw new PropelException("Error populating GoodsInSale object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = GoodsInSalePeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($ret) {
				...
				$this->postSave($con);
				GoodsInSalePeer::addInstanceToPool($this);
			} else {
				$affectedRows = 0;
			}
			$con->commit();
	...
	{
		$pos = GoodsInSalePeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
	{
		...
		$alreadyDumpedObjects['GoodsInSale'][$this->getPrimaryKey()] = true;
		$keys = GoodsInSalePeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getId(),
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[3], $arr)) $this->setSaleId($arr[$keys[3]]);
		if (array_key_exists($keys[4], $arr)) $this->setGoodId($arr[$keys[4]]);
	}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(GoodsInSalePeer::ID)) $criteria->add(GoodsInSalePeer::ID, $this->id);
		if ($this->isColumnModified(GoodsInSalePeer::PRICE)) $criteria->add(GoodsInSalePeer::PRICE, $this->price);
		if ($this->isColumnModified(GoodsInSalePeer::COUNT)) $criteria->add(GoodsInSalePeer::COUNT, $this->count);
		if ($this->isColumnModified(GoodsInSalePeer::SALE_ID)) $criteria->add(GoodsInSalePeer::SALE_ID, $this->sale_id);
		if ($this->isColumnModified(GoodsInSalePeer::GOOD_ID)) $criteria->add(GoodsInSalePeer::GOOD_ID, $this->good_id);
	...
	{
		$criteria = new Criteria(GoodsInSalePeer::DATABASE_NAME);
		$criteria->add(GoodsInSalePeer::ID, $this->id);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of GoodsInSale (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     GoodsInSale Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     GoodsInSalePeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new GoodsInSalePeer();
		}
		return self::$peer;
	}
	...
	{
		return (string) $this->exportTo(GoodsInSalePeer::DEFAULT_STRING_FORMAT);
	}
