...
abstract class BasePublisherPeer {
	...
	/**
	 * Method perform an INSERT on the database, given a Publisher or Criteria object.
	 *
	...
	/**
	 * Method perform an UPDATE on the database, given a Publisher or Criteria object.
	 *
	...
	/**
	 * Method to DELETE all rows from the publisher table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
	...
	/**
	 * Method perform a DELETE on the database, given a Publisher or Criteria object OR a primary key value.
	 *
