...
abstract class BaseSalesPeer {
	...
	const CLASS_DEFAULT = 'cyberstore.Sales';
	...
	protected static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'Date', 'UserId', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'date', 'userId', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::DATE, self::USER_ID, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID', 'DATE', 'USER_ID', ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'date', 'user_id', ),
	...
	protected static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Date' => 1, 'UserId' => 2, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'date' => 1, 'userId' => 2, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::DATE => 1, self::USER_ID => 2, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'DATE' => 1, 'USER_ID' => 2, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'date' => 1, 'user_id' => 2, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, )
	);
	...
	public static function addSelectColumns(Criteria $criteria, $alias = null)
	{
		if (null === $alias) {
			...
			$criteria->addSelectColumn(SalesPeer::DATE);
			$criteria->addSelectColumn(SalesPeer::USER_ID);
		} else {
	...
	public static function doCountJoinUser(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(SalesPeer::USER_ID, UserPeer::ID, $join_behavior);
	...
	public static function doUpdate($values, PropelPDO $con = null)
	{
		...
		if ($values instanceof Criteria) {
			...
			$value = $criteria->remove(SalesPeer::ID);
			if ($value) {
				$selectCriteria->add(SalesPeer::ID, $value, $comparison);
			} else {
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		try {
			...
			$c = clone $criteria;
			$affectedRows += SalesPeer::doOnDeleteCascade($c, $con);
	...
	protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
	{
		...
		foreach ($objects as $obj) {
			...
			$criteria->add(GoodsInSalePeer::SALE_ID, $obj->getId());
