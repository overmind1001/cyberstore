...
abstract class BaseSession extends BaseObject  implements Persistent
{
	...
	public function setBasketId($v)
	{
		...
		if ($this->basket_id !== $v) {
			$this->basket_id = $v;
			$this->modifiedColumns[] = SessionPeer::BASKET_ID;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 3; // 3 = SessionPeer::NUM_HYDRATE_COLUMNS.
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(SessionPeer::BASKET_ID)) $criteria->add(SessionPeer::BASKET_ID, $this->basket_id);
