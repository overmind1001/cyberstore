...
abstract class BaseFeedback extends BaseObject  implements Persistent
{
	...
	public function setText($v)
	{
		...
		if ($this->text !== $v) {
			$this->text = $v;
			$this->modifiedColumns[] = FeedbackPeer::TEXT;
		}
	...
	public function setDate($v)
	{
		...
		if ($this->date !== null || $dt !== null) {
			...
			if ($currentDateAsString !== $newDateAsString) {
				...
				$this->modifiedColumns[] = FeedbackPeer::DATE;
			}
	...
	public function setMark($v)
	{
		...
		if ($this->mark !== $v) {
			$this->mark = $v;
			$this->modifiedColumns[] = FeedbackPeer::MARK;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->mark = ($row[$startcol + 3] !== null) ? (int) $row[$startcol + 3] : null;
			...
			return $startcol + 5; // 5 = FeedbackPeer::NUM_HYDRATE_COLUMNS.
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(FeedbackPeer::TEXT)) $criteria->add(FeedbackPeer::TEXT, $this->text);
		if ($this->isColumnModified(FeedbackPeer::DATE)) $criteria->add(FeedbackPeer::DATE, $this->date);
		if ($this->isColumnModified(FeedbackPeer::MARK)) $criteria->add(FeedbackPeer::MARK, $this->mark);
		if ($this->isColumnModified(FeedbackPeer::GOOD_ID)) $criteria->add(FeedbackPeer::GOOD_ID, $this->good_id);
