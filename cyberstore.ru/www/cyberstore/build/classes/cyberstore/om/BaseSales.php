...
abstract class BaseSales extends BaseObject  implements Persistent
{
	...
	public function setDate($v)
	{
		...
		if ($this->date !== null || $dt !== null) {
			...
			if ($currentDateAsString !== $newDateAsString) {
				...
				$this->modifiedColumns[] = SalesPeer::DATE;
			}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 3; // 3 = SalesPeer::NUM_HYDRATE_COLUMNS.
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(SalesPeer::DATE)) $criteria->add(SalesPeer::DATE, $this->date);
		if ($this->isColumnModified(SalesPeer::USER_ID)) $criteria->add(SalesPeer::USER_ID, $this->user_id);
