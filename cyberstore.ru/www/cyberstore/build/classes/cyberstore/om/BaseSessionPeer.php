...
abstract class BaseSessionPeer {
	...
	const CLASS_DEFAULT = 'cyberstore.Session';
	...
	const BASKET_ID = 'session.BASKET_ID';
	...
	protected static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'BasketId', 'UserId', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'basketId', 'userId', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::BASKET_ID, self::USER_ID, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID', 'BASKET_ID', 'USER_ID', ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'basket_id', 'user_id', ),
	...
	protected static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'BasketId' => 1, 'UserId' => 2, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'basketId' => 1, 'userId' => 2, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::BASKET_ID => 1, self::USER_ID => 2, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'BASKET_ID' => 1, 'USER_ID' => 2, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'basket_id' => 1, 'user_id' => 2, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, )
	);
	...
	public static function addSelectColumns(Criteria $criteria, $alias = null)
	{
		if (null === $alias) {
			...
			$criteria->addSelectColumn(SessionPeer::BASKET_ID);
